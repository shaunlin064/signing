    ...
    <fieldset :id='dom_id'>
        ...
        <div class="row">
            <div class='row col-md-12'>
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input type="text" id="apply_subject" class="form-control" placeholder="名稱" name="apply_subject" v-model='form_submit_data[dom_id]["apply_subject"]' :disabled='can_edit === false'>
                        <label for="apply_subject">名稱</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input type="text" id="campaign_id" class="form-control" placeholder="案件編號" name="campaign_id" v-model='form_submit_data[dom_id]["campaign_id"]' :disabled='can_edit === false'>
            ...
            <div class='row col-md-12 p-1'>
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input type="text" id="receipt_number" class="form-control" placeholder="發票號碼" v-model='form_submit_data[dom_id]["receipt_number"]' :disabled='can_edit === false'
                               name="receipt_number">
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input type="text" id="receipt_date" class="form-control" placeholder="開立發票日期" v-model='form_submit_data[dom_id]["receipt_date"]' :disabled='can_edit === false'
                               name="receipt_date">
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input type="text" id="receipt_price" class="form-control" placeholder="發票金額(稅)" v-model='form_submit_data[dom_id]["receipt_price"]' :disabled='can_edit === false'
                               name="receipt_price">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="custom-select select2 form-control" id="pay_type" name="pay_type" v-model='form_submit_data[dom_id]["pay_type"]' :disabled='can_edit === false'>
